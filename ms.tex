...
\begin{figure*}[!t]
	\rotatebox[origin=l]{90}{\hspace{1em}\scriptsize Normalized frequencies}\subfloat[Lung segmentation]{\includegraphics[width=0.33\textwidth]{results/lung-segmentation-hist}}
...
\begin{figure}[!t]
	\centering
	\rotatebox[origin=l]{90}{\tiny Lung segmentation}\subfloat{\includegraphics[width=0.12\textwidth]{results/lung-segmentation-Unet-\best-masked-image}}
	...
	\\
	\rotatebox[origin=l]{90}{\tiny Lesion segmentation A}\subfloat{\includegraphics[width=0.12\textwidth]{results/lesion-segmentation-a-Unet-\best-masked-image}}
	...
	\\
	\rotatebox[origin=l]{90}{\tiny Lesion segmentation B}\subfloat{\includegraphics[width=0.12\textwidth]{results/lesion-segmentation-b-Unet-\best-masked-image}}
	...
	\\
	\rotatebox[origin=l]{90}{\tiny Lesion segmentation A}\subfloat{\includegraphics[width=0.12\textwidth]{results/lesion-segmentation-a-Unet-\worst-masked-image}}
	...
	\rotatebox[origin=l]{90}{\tiny Lesion segmentation B}\subfloat[{\tiny Unet}]{\includegraphics[width=0.12\textwidth]{results/lesion-segmentation-b-Unet-\worst-masked-image}}
	\subfloat[{\tiny Linknet}]{\includegraphics[width=0.12\textwidth]{results/lesion-segmentation-b-Linknet-\worst-masked-image}}
	\subfloat[{\tiny FPN}]{\includegraphics[width=0.12\textwidth]{results/lesion-segmentation-b-FPN-\worst-masked-image}}
	\subfloat[{\tiny PSPNet}]{\includegraphics[width=0.12\textwidth]{results/lesion-segmentation-b-PSPNet-\worst-masked-image}}
...
\begin{figure}[!t]
	\centering
	\rotatebox[origin=l]{90}{\hspace{2em}\scriptsize Dice(\%)}\subfloat[Lung segmentation]{\includegraphics[width=0.24\textwidth]{results/lung-segmentation-scatter-dice-vs-num-parameters}}
	...
	\\
	\rotatebox[origin=l]{90}{\hspace{2em}\scriptsize Dice(\%)}\subfloat[Lesion segmentation B]{\includegraphics[width=0.24\textwidth]{results/lesion-segmentation-b-scatter-dice-vs-num-parameters}}
...
\begin{table*}[!t]
	...
	\scalebox{0.35}{\input{results/metrics.tex}}
\end{table*}
...
\begin{figure}[!t]
	\centering
	\rotatebox[origin=l]{90}{\scriptsize Lung segmentation}\subfloat{\includegraphics[width=0.24\textwidth]{results/lung-segmentation-train-loss}}
	\subfloat{\includegraphics[width=0.24\textwidth]{results/lung-segmentation-validation-loss}}
	\\
	\rotatebox[origin=l]{90}{\scriptsize Lesion segmentation A}\subfloat{\includegraphics[width=0.24\textwidth]{results/lesion-segmentation-a-train-loss}}
	\subfloat{\includegraphics[width=0.24\textwidth]{results/lesion-segmentation-a-validation-loss}}
	\\
	\rotatebox[origin=l]{90}{\scriptsize Lesion segmentation B}\subfloat{\includegraphics[width=0.24\textwidth]{results/lesion-segmentation-b-train-loss}}
	\subfloat{\includegraphics[width=0.24\textwidth]{results/lesion-segmentation-b-validation-loss}}
	\\
	\setcounter{subfigure}{0}
	\rotatebox[origin=l]{90}{\scriptsize Lesion segmentation B-A}\subfloat[Train loss]{\includegraphics[width=0.24\textwidth]{results/lesion-segmentation-b-train-diff-loss}}
...
\begin{figure}[!t]
	\centering
	\rotatebox[origin=l]{90}{\hspace{1.5em}\scriptsize Dice(\%)}\subfloat[Lung segmentation]{\includegraphics[width=0.24\textwidth]{results/lung-segmentation-boxplot-dice}}
	\subfloat[Lesion segmentation A]{\includegraphics[width=0.24\textwidth]{results/lesion-segmentation-a-boxplot-dice}}
	\\
	\rotatebox[origin=l]{90}{\hspace{1.5em}\scriptsize Dice(\%)}\subfloat[Lesion segmentation B]{\includegraphics[width=0.24\textwidth]{results/lesion-segmentation-b-boxplot-dice}}
...
\begin{figure}[!t]
	\centering
	\rotatebox[origin=l]{90}{\scriptsize Random initialization}\subfloat{\includegraphics[width=0.24\textwidth]{results/lung-segmentation-Unet-None-before-weights}}
	\subfloat{\includegraphics[width=0.24\textwidth]{results/lung-segmentation-Unet-None-after-weights}}
	\\
	\setcounter{subfigure}{0}
	\rotatebox[origin=l]{90}{\scriptsize ImageNet initialization}\subfloat[Before training]{\includegraphics[width=0.24\textwidth]{results/lung-segmentation-Unet-imagenet-before-weights}}
