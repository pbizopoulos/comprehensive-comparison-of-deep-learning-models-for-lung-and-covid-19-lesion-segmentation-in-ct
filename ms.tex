...
\begin{abstract}
	...
	However the field's reliability is hindered by the lack of a common base of reference for accuracy/performance evaluation and the fact that previous research uses different datasets for evaluation.
	...
	A public COVID-19 dataset with $100$ CT scan images ($80$ for train, $20$ for validation) is used for training/validation and a different public dataset consisting of $\DTLfetch{keys_values}{key}{num_slices_test}{value}$ images from $9$ CT scan volumes for testing.
	...
	Finally, the upper bounds improvements when using lung masks as a preprocessing step or when using pretrained models are quantified.
...
\begin{figure}[!t]
	\centering
	\begin{tikzpicture}[]
		\node[] (input) {\includegraphics[scale=0.3]{results/lesion-segmentation-a-image}};
		...
		\node[] (output) [right=0.5cm of encoder]{\includegraphics[scale=0.3]{results/lesion-segmentation-a-prediction-train-masked-image}};
		\node[draw, below=0.5cm of output, circle] (loss){$\mathcal{L}$};
		\node[] (mask) [below=0.5cm of loss]{\includegraphics[scale=0.3]{results/lesion-segmentation-a-mask-train-masked-image}};
		\node[] at (0, 1){$\bm{X}$};
	...
	This procedure is repeated for a number of times using more training examples till $\mathcal{L}$ converges.}
...
\begin{figure*}[!t]
	\rotatebox[origin=l]{90}{\hspace{4em}\scriptsize Normalized frequencies}\subfloat[Lung segmentation]{\includegraphics[width=0.33\textwidth]{results/lung-segmentation-hist}}
	\subfloat[Lesion segmentation A]{\includegraphics[width=0.33\textwidth]{results/lesion-segmentation-a-hist}}
	\subfloat[Lesion segmentation B]{\includegraphics[width=0.33\textwidth]{results/lesion-segmentation-b-hist}}
	...
	The outlier bar at zero is because most of the pixels in the target masks are near zero.}
	\label{fig:hist}
\end{figure*}
...
The best performing models w.r.t.\ Dice for each experiment were the \DTLfetch{keys_values}{key}{lung-segmentation-architecture-imagenet-index-max}{value}-\DTLfetch{keys_values}{key}{lung-segmentation-encoder-imagenet-index-max}{value} ($\DTLfetch{keys_values}{key}{lung-segmentation-imagenet-max}{value}\%$) for lung segmentation, \DTLfetch{keys_values}{key}{lesion-segmentation-a-architecture-imagenet-index-max}{value}-\DTLfetch{keys_values}{key}{lesion-segmentation-a-encoder-imagenet-index-max}{value} ($\DTLfetch{keys_values}{key}{lesion-segmentation-a-imagenet-max}{value}\%$) for lesion segmentation A and \DTLfetch{keys_values}{key}{lesion-segmentation-b-architecture-imagenet-index-max}{value}-\DTLfetch{keys_values}{key}{lesion-segmentation-b-encoder-imagenet-index-max}{value} ($\DTLfetch{keys_values}{key}{lesion-segmentation-b-imagenet-max}{value}\%$) for lesion segmentation B.
In Fig.~\ref{fig:predictedmasks} the predicted masks for $24$ out of the $600$ models are depicted, demonstrating the difference in segmentation quality between the best (\DTLfetch{keys_values}{key}{encoder-best}{value}) and the worst (\DTLfetch{keys_values}{key}{encoder-worst}{value}) performing encoder of the models for each architecture, with randomly initialized weights.
...
\DTLfetchsave{\best}{keys_values}{key}{encoder-best}{value}
\DTLfetchsave{\worst}{keys_values}{key}{encoder-worst}{value}

\begin{figure}[!t]
	\centering
	\rotatebox[origin=l]{90}{\hspace{1em}\tiny Lung segmentation}\subfloat{\includegraphics[width=0.12\textwidth]{results/lung-segmentation-Unet-\best-masked-image}}
	\subfloat{\includegraphics[width=0.12\textwidth]{results/lung-segmentation-Linknet-\best-masked-image}}
	\subfloat{\includegraphics[width=0.12\textwidth]{results/lung-segmentation-FPN-\best-masked-image}}
	\subfloat{\includegraphics[width=0.12\textwidth]{results/lung-segmentation-PSPNet-\best-masked-image}}
	\\
	\rotatebox[origin=l]{90}{\hspace{0.7em}\tiny Lesion segmentation A}\subfloat{\includegraphics[width=0.12\textwidth]{results/lesion-segmentation-a-Unet-\best-masked-image}}
	\subfloat{\includegraphics[width=0.12\textwidth]{results/lesion-segmentation-a-Linknet-\best-masked-image}}
	\subfloat{\includegraphics[width=0.12\textwidth]{results/lesion-segmentation-a-FPN-\best-masked-image}}
	\subfloat{\includegraphics[width=0.12\textwidth]{results/lesion-segmentation-a-PSPNet-\best-masked-image}}
	\\
	\rotatebox[origin=l]{90}{\hspace{0.7em}\tiny Lesion segmentation B}\subfloat{\includegraphics[width=0.12\textwidth]{results/lesion-segmentation-b-Unet-\best-masked-image}}
	\subfloat{\includegraphics[width=0.12\textwidth]{results/lesion-segmentation-b-Linknet-\best-masked-image}}
	\subfloat{\includegraphics[width=0.12\textwidth]{results/lesion-segmentation-b-FPN-\best-masked-image}}
	\subfloat{\includegraphics[width=0.12\textwidth]{results/lesion-segmentation-b-PSPNet-\best-masked-image}}
	\\
	\rotatebox[origin=l]{90}{\hspace{1em}\tiny Lung segmentation}\subfloat{\includegraphics[width=0.12\textwidth]{results/lung-segmentation-Unet-\best-masked-image}}
	\subfloat{\includegraphics[width=0.12\textwidth]{results/lung-segmentation-Linknet-\worst-masked-image}}
	\subfloat{\includegraphics[width=0.12\textwidth]{results/lung-segmentation-FPN-\worst-masked-image}}
	\subfloat{\includegraphics[width=0.12\textwidth]{results/lung-segmentation-PSPNet-\worst-masked-image}}
	\\
	\rotatebox[origin=l]{90}{\hspace{0.7em}\tiny Lesion segmentation A}\subfloat{\includegraphics[width=0.12\textwidth]{results/lesion-segmentation-a-Unet-\worst-masked-image}}
	\subfloat{\includegraphics[width=0.12\textwidth]{results/lesion-segmentation-a-Linknet-\worst-masked-image}}
	\subfloat{\includegraphics[width=0.12\textwidth]{results/lesion-segmentation-a-FPN-\worst-masked-image}}
	\subfloat{\includegraphics[width=0.12\textwidth]{results/lesion-segmentation-a-PSPNet-\worst-masked-image}}
	\\
	\setcounter{subfigure}{0}
	\rotatebox[origin=l]{90}{\hspace{0.7em}\tiny Lesion segmentation B}\subfloat[Unet]{\includegraphics[width=0.12\textwidth]{results/lesion-segmentation-b-Unet-\worst-masked-image}}
	\subfloat[Linknet]{\includegraphics[width=0.12\textwidth]{results/lesion-segmentation-b-Linknet-\worst-masked-image}}
	\subfloat[FPN]{\includegraphics[width=0.12\textwidth]{results/lesion-segmentation-b-FPN-\worst-masked-image}}
	\subfloat[PSPNet]{\includegraphics[width=0.12\textwidth]{results/lesion-segmentation-b-PSPNet-\worst-masked-image}}
	...
	Green and red depict correctly and falsely classified pixels respectively.}
	\label{fig:predictedmasks}
\end{figure}

\begin{figure}[!t]
	\rotatebox[origin=l]{90}{\hspace{4em}\scriptsize Dice(\%)}\subfloat[Lung segmentation]{\includegraphics[width=0.24\textwidth]{results/lung-segmentation-scatter-dice-vs-num-parameters}}
	\subfloat[Lesion segmentation A]{\includegraphics[width=0.24\textwidth]{results/lesion-segmentation-a-scatter-dice-vs-num-parameters}}
	\\
	\rotatebox[origin=l]{90}{\hspace{4em}\scriptsize Dice(\%)}\subfloat[Lesion segmentation B]{\includegraphics[width=0.24\textwidth]{results/lesion-segmentation-b-scatter-dice-vs-num-parameters}}
	\subfloat[Lesion segmentation B-A]{\includegraphics[width=0.24\textwidth]{results/diff-scatter-dice-vs-num-parameters}}
	...
	The method used to calculate the estimator bandwidth was Scott and the points are assumed to be equally weighted.}
	\label{fig:dicevsnumparameters}
\end{figure}
...
\begin{figure}[!t]
	\rotatebox[origin=l]{90}{\hspace{2em}\scriptsize Lung segmentation}\subfloat{\includegraphics[width=0.24\textwidth]{results/lung-segmentation-train-loss}}
	\subfloat{\includegraphics[width=0.24\textwidth]{results/lung-segmentation-validation-loss}}
	\\
	\rotatebox[origin=l]{90}{\hspace{1.2em}\scriptsize Lesion segmentation A}\subfloat{\includegraphics[width=0.24\textwidth]{results/lesion-segmentation-a-train-loss}}
	\subfloat{\includegraphics[width=0.24\textwidth]{results/lesion-segmentation-a-validation-loss}}
	\\
	\rotatebox[origin=l]{90}{\hspace{1.8em}\scriptsize Lesion segmentation B}\subfloat{\includegraphics[width=0.24\textwidth]{results/lesion-segmentation-b-train-loss}}
	\subfloat{\includegraphics[width=0.24\textwidth]{results/lesion-segmentation-b-validation-loss}}
	\\
	\setcounter{subfigure}{0}
	\rotatebox[origin=l]{90}{\hspace{1.3em}\scriptsize Lesion segmentation B-A}\subfloat[Train loss]{\includegraphics[width=0.24\textwidth]{results/lesion-segmentation-b-train-diff-loss}}
	\subfloat[Validation loss]{\includegraphics[width=0.24\textwidth]{results/lesion-segmentation-b-validation-diff-loss}}
...
\begin{figure}[!t]
	\rotatebox[origin=l]{90}{\hspace{3.5em}\scriptsize Dice(\%)}\subfloat[Lung segmentation]{\includegraphics[width=0.24\textwidth]{results/lung-segmentation-boxplot-dice}}
	\subfloat[Lesion segmentation A]{\includegraphics[width=0.24\textwidth]{results/lesion-segmentation-a-boxplot-dice}}
	\\
	\rotatebox[origin=l]{90}{\hspace{3.5em}\scriptsize Dice(\%)}\subfloat[Lesion segmentation B]{\includegraphics[width=0.24\textwidth]{results/lesion-segmentation-b-boxplot-dice}}
	\subfloat[Initialization]{\includegraphics[width=0.24\textwidth]{results/initialization-boxplot-dice}}
	\caption{Boxplots of Dice for the three experiments and for each architecture in (a), (b) and (c) and weight initialization for all experiments in (d).}
	\label{fig:box}
\end{figure}
...
\begin{figure*}[!t]
	\rotatebox[origin=l]{90}{\hspace{1em}\scriptsize Lung segmentation}\subfloat{\includegraphics[width=0.20\textwidth]{results/lung-segmentation-mask--volume}}
	\subfloat{\includegraphics[width=0.20\textwidth]{results/lung-segmentation-Unet-None-volume}}
	\subfloat{\includegraphics[width=0.20\textwidth]{results/lung-segmentation-Linknet-None-volume}}
	\subfloat{\includegraphics[width=0.20\textwidth]{results/lung-segmentation-FPN-None-volume}}
	\subfloat{\includegraphics[width=0.20\textwidth]{results/lung-segmentation-PSPNet-None-volume}}
	\\
	\rotatebox[origin=l]{90}{\hspace{0.8em}\scriptsize Lesion segmentation A}\subfloat{\includegraphics[width=0.20\textwidth]{results/lesion-segmentation-a-mask--volume}}
	\subfloat{\includegraphics[width=0.20\textwidth]{results/lesion-segmentation-a-Unet-None-volume}}
	\subfloat{\includegraphics[width=0.20\textwidth]{results/lesion-segmentation-a-Linknet-None-volume}}
	\subfloat{\includegraphics[width=0.20\textwidth]{results/lesion-segmentation-a-FPN-None-volume}}
	\subfloat{\includegraphics[width=0.20\textwidth]{results/lesion-segmentation-a-PSPNet-None-volume}}
	\\
	\setcounter{subfigure}{0}
	\rotatebox[origin=l]{90}{\hspace{0.8em}\scriptsize Lesion segmentation B}\subfloat[Mask]{\includegraphics[width=0.20\textwidth]{results/lesion-segmentation-b-mask--volume}}
	\subfloat[Unet]{\includegraphics[width=0.20\textwidth]{results/lesion-segmentation-b-Unet-None-volume}}
	\subfloat[Linknet]{\includegraphics[width=0.20\textwidth]{results/lesion-segmentation-b-Linknet-None-volume}}
	\subfloat[FPN]{\includegraphics[width=0.20\textwidth]{results/lesion-segmentation-b-FPN-None-volume}}
	\subfloat[PSPNet]{\includegraphics[width=0.20\textwidth]{results/lesion-segmentation-b-PSPNet-None-volume}}
	\caption{Reconstructed volumes from predicted masks.
	Reconstruction was done by stacking the predicted masks on the z-axis and then applying the marching cubes algorithm.}
	\label{fig:volumes}
\end{figure*}
...
\begin{figure}[!t]
	\rotatebox[origin=l]{90}{\hspace{2.8em}\scriptsize Random initialization}\subfloat{\includegraphics[width=0.24\textwidth]{results/lung-segmentation-Unet-None-before-weights}}
	\subfloat{\includegraphics[width=0.24\textwidth]{results/lung-segmentation-Unet-None-after-weights}}
	\\
	\setcounter{subfigure}{0}
	\rotatebox[origin=l]{90}{\hspace{2.8em}\scriptsize ImageNet initialization}\subfloat[Before training]{\includegraphics[width=0.24\textwidth]{results/lung-segmentation-Unet-imagenet-before-weights}}
	\subfloat[After training]{\includegraphics[width=0.24\textwidth]{results/lung-segmentation-Unet-imagenet-after-weights}}
