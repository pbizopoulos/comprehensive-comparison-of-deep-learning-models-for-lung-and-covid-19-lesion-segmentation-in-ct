...
\begin{figure}[!t]
	\centering
	\begin{tikzpicture}[]
		\node[] (input) {\includegraphics[scale=0.3]{python/bin/lesion-segmentation-a-image}};
		...
		\node[] (output) [right=0.5cm of encoder]{\includegraphics[scale=0.3]{python/bin/lesion-segmentation-a-prediction-train-masked-image}};
		\node[draw, below=0.5cm of output, circle] (loss){$\mathcal{L}$};
		\node[] (mask) [below=0.5cm of loss]{\includegraphics[scale=0.3]{python/bin/lesion-segmentation-a-mask-train-masked-image}};
		\node[] at (0, 1){$\bm{X}$};
...
\begin{figure*}[!t]
	\rotatebox[origin=l]{90}{\hspace{1em}\scriptsize Normalized frequencies}\subfloat[Lung segmentation]{\includegraphics[width=0.33\textwidth]{python/bin/lung-segmentation-hist}}
	\subfloat[Lesion segmentation A]{\includegraphics[width=0.33\textwidth]{python/bin/lesion-segmentation-a-hist}}
	\subfloat[Lesion segmentation B]{\includegraphics[width=0.33\textwidth]{python/bin/lesion-segmentation-b-hist}}
...
\begin{figure}[!t]
	\centering
	\rotatebox[origin=l]{90}{\tiny Lung segmentation}\subfloat{\includegraphics[width=0.12\textwidth]{python/bin/lung-segmentation-Unet-\best-masked-image}}
	\subfloat{\includegraphics[width=0.12\textwidth]{python/bin/lung-segmentation-Linknet-\best-masked-image}}
	\subfloat{\includegraphics[width=0.12\textwidth]{python/bin/lung-segmentation-FPN-\best-masked-image}}
	\subfloat{\includegraphics[width=0.12\textwidth]{python/bin/lung-segmentation-PSPNet-\best-masked-image}}
	\\
	\rotatebox[origin=l]{90}{\tiny Lesion segmentation A}\subfloat{\includegraphics[width=0.12\textwidth]{python/bin/lesion-segmentation-a-Unet-\best-masked-image}}
	\subfloat{\includegraphics[width=0.12\textwidth]{python/bin/lesion-segmentation-a-Linknet-\best-masked-image}}
	\subfloat{\includegraphics[width=0.12\textwidth]{python/bin/lesion-segmentation-a-FPN-\best-masked-image}}
	\subfloat{\includegraphics[width=0.12\textwidth]{python/bin/lesion-segmentation-a-PSPNet-\best-masked-image}}
	\\
	\rotatebox[origin=l]{90}{\tiny Lesion segmentation B}\subfloat{\includegraphics[width=0.12\textwidth]{python/bin/lesion-segmentation-b-Unet-\best-masked-image}}
	\subfloat{\includegraphics[width=0.12\textwidth]{python/bin/lesion-segmentation-b-Linknet-\best-masked-image}}
	\subfloat{\includegraphics[width=0.12\textwidth]{python/bin/lesion-segmentation-b-FPN-\best-masked-image}}
	\subfloat{\includegraphics[width=0.12\textwidth]{python/bin/lesion-segmentation-b-PSPNet-\best-masked-image}}
	\\
	\rotatebox[origin=l]{90}{\tiny Lung segmentation}\subfloat{\includegraphics[width=0.12\textwidth]{python/bin/lung-segmentation-Unet-\best-masked-image}}
	\subfloat{\includegraphics[width=0.12\textwidth]{python/bin/lung-segmentation-Linknet-\worst-masked-image}}
	\subfloat{\includegraphics[width=0.12\textwidth]{python/bin/lung-segmentation-FPN-\worst-masked-image}}
	\subfloat{\includegraphics[width=0.12\textwidth]{python/bin/lung-segmentation-PSPNet-\worst-masked-image}}
	\\
	\rotatebox[origin=l]{90}{\tiny Lesion segmentation A}\subfloat{\includegraphics[width=0.12\textwidth]{python/bin/lesion-segmentation-a-Unet-\worst-masked-image}}
	\subfloat{\includegraphics[width=0.12\textwidth]{python/bin/lesion-segmentation-a-Linknet-\worst-masked-image}}
	\subfloat{\includegraphics[width=0.12\textwidth]{python/bin/lesion-segmentation-a-FPN-\worst-masked-image}}
	\subfloat{\includegraphics[width=0.12\textwidth]{python/bin/lesion-segmentation-a-PSPNet-\worst-masked-image}}
	\\
	\setcounter{subfigure}{0}
	\rotatebox[origin=l]{90}{\tiny Lesion segmentation B}\subfloat[{\tiny Unet}]{\includegraphics[width=0.12\textwidth]{python/bin/lesion-segmentation-b-Unet-\worst-masked-image}}
	\subfloat[{\tiny Linknet}]{\includegraphics[width=0.12\textwidth]{python/bin/lesion-segmentation-b-Linknet-\worst-masked-image}}
	\subfloat[{\tiny FPN}]{\includegraphics[width=0.12\textwidth]{python/bin/lesion-segmentation-b-FPN-\worst-masked-image}}
	\subfloat[{\tiny PSPNet}]{\includegraphics[width=0.12\textwidth]{python/bin/lesion-segmentation-b-PSPNet-\worst-masked-image}}
...
\begin{figure}[!t]
	\centering
	\rotatebox[origin=l]{90}{\hspace{2em}\scriptsize Dice (\%)}\subfloat[Lung segmentation]{\includegraphics[width=0.24\textwidth]{python/bin/lung-segmentation-scatter-dice-vs-num-parameters}}
	\subfloat[Lesion segmentation A]{\includegraphics[width=0.24\textwidth]{python/bin/lesion-segmentation-a-scatter-dice-vs-num-parameters}}
	\\
	\rotatebox[origin=l]{90}{\hspace{2em}\scriptsize Dice (\%)}\subfloat[Lesion segmentation B]{\includegraphics[width=0.24\textwidth]{python/bin/lesion-segmentation-b-scatter-dice-vs-num-parameters}}
	\subfloat[Lesion segmentation B-A]{\includegraphics[width=0.24\textwidth]{python/bin/diff-scatter-dice-vs-num-parameters}}
...
\begin{figure}[!t]
	\centering
	\rotatebox[origin=l]{90}{\scriptsize Lung segmentation}\subfloat{\includegraphics[width=0.24\textwidth]{python/bin/lung-segmentation-train-loss}}
	\subfloat{\includegraphics[width=0.24\textwidth]{python/bin/lung-segmentation-validation-loss}}
	\\
	\rotatebox[origin=l]{90}{\scriptsize Lesion segmentation A}\subfloat{\includegraphics[width=0.24\textwidth]{python/bin/lesion-segmentation-a-train-loss}}
	\subfloat{\includegraphics[width=0.24\textwidth]{python/bin/lesion-segmentation-a-validation-loss}}
	\\
	\rotatebox[origin=l]{90}{\scriptsize Lesion segmentation B}\subfloat{\includegraphics[width=0.24\textwidth]{python/bin/lesion-segmentation-b-train-loss}}
	\subfloat{\includegraphics[width=0.24\textwidth]{python/bin/lesion-segmentation-b-validation-loss}}
	\\
	\setcounter{subfigure}{0}
	\rotatebox[origin=l]{90}{\scriptsize Lesion segmentation B-A}\subfloat[Train loss]{\includegraphics[width=0.24\textwidth]{python/bin/lesion-segmentation-b-train-diff-loss}}
	\subfloat[Validation loss]{\includegraphics[width=0.24\textwidth]{python/bin/lesion-segmentation-b-validation-diff-loss}}
...
\begin{figure}[!t]
	\centering
	\rotatebox[origin=l]{90}{\hspace{1.5em}\scriptsize Dice (\%)}\subfloat[Lung segmentation]{\includegraphics[width=0.24\textwidth]{python/bin/lung-segmentation-boxplot-dice}}
	\subfloat[Lesion segmentation A]{\includegraphics[width=0.24\textwidth]{python/bin/lesion-segmentation-a-boxplot-dice}}
	\\
	\rotatebox[origin=l]{90}{\hspace{1.5em}\scriptsize Dice (\%)}\subfloat[Lesion segmentation B]{\includegraphics[width=0.24\textwidth]{python/bin/lesion-segmentation-b-boxplot-dice}}
	\subfloat[Initialization]{\includegraphics[width=0.24\textwidth]{python/bin/initialization-boxplot-dice}}
...
\begin{figure*}[!t]
	\rotatebox[origin=l]{90}{\hspace{1em}\scriptsize Lung segmentation}\subfloat{\includegraphics[width=0.20\textwidth]{python/bin/lung-segmentation-mask--volume}} % chktex 8
	\subfloat{\includegraphics[width=0.20\textwidth]{python/bin/lung-segmentation-Unet-None-volume}}
	\subfloat{\includegraphics[width=0.20\textwidth]{python/bin/lung-segmentation-Linknet-None-volume}}
	\subfloat{\includegraphics[width=0.20\textwidth]{python/bin/lung-segmentation-FPN-None-volume}}
	\subfloat{\includegraphics[width=0.20\textwidth]{python/bin/lung-segmentation-PSPNet-None-volume}}
	\\
	\rotatebox[origin=l]{90}{\hspace{0.8em}\scriptsize Lesion segmentation A}\subfloat{\includegraphics[width=0.20\textwidth]{python/bin/lesion-segmentation-a-mask--volume}} % chktex 8
	\subfloat{\includegraphics[width=0.20\textwidth]{python/bin/lesion-segmentation-a-Unet-None-volume}}
	\subfloat{\includegraphics[width=0.20\textwidth]{python/bin/lesion-segmentation-a-Linknet-None-volume}}
	\subfloat{\includegraphics[width=0.20\textwidth]{python/bin/lesion-segmentation-a-FPN-None-volume}}
	\subfloat{\includegraphics[width=0.20\textwidth]{python/bin/lesion-segmentation-a-PSPNet-None-volume}}
	\\
	\setcounter{subfigure}{0}
	\rotatebox[origin=l]{90}{\hspace{0.8em}\scriptsize Lesion segmentation B}\subfloat[Mask]{\includegraphics[width=0.20\textwidth]{python/bin/lesion-segmentation-b-mask--volume}} % chktex 8
	\subfloat[Unet]{\includegraphics[width=0.20\textwidth]{python/bin/lesion-segmentation-b-Unet-None-volume}}
	\subfloat[Linknet]{\includegraphics[width=0.20\textwidth]{python/bin/lesion-segmentation-b-Linknet-None-volume}}
	\subfloat[FPN]{\includegraphics[width=0.20\textwidth]{python/bin/lesion-segmentation-b-FPN-None-volume}}
	\subfloat[PSPNet]{\includegraphics[width=0.20\textwidth]{python/bin/lesion-segmentation-b-PSPNet-None-volume}}
...
\begin{figure}[!t]
	\centering
	\rotatebox[origin=l]{90}{\scriptsize Random initialization}\subfloat{\includegraphics[width=0.24\textwidth]{python/bin/lung-segmentation-Unet-None-before-weights}}
	\subfloat{\includegraphics[width=0.24\textwidth]{python/bin/lung-segmentation-Unet-None-after-weights}}
	\\
	\setcounter{subfigure}{0}
	\rotatebox[origin=l]{90}{\scriptsize ImageNet initialization}\subfloat[Before training]{\includegraphics[width=0.24\textwidth]{python/bin/lung-segmentation-Unet-imagenet-before-weights}}
	\subfloat[After training]{\includegraphics[width=0.24\textwidth]{python/bin/lung-segmentation-Unet-imagenet-after-weights}}
