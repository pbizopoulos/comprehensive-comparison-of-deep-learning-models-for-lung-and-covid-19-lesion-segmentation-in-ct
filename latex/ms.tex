...
\begin{figure}[!t]
	\centering
	\begin{tikzpicture}[]
		\node[] (input) {\includegraphics[scale=0.3]{python/bin/lesion-segmentation-a-image.png}};
		...
		\node[] (output) [right=0.5cm of encoder]{\includegraphics[scale=0.3]{python/bin/lesion-segmentation-a-prediction-train-masked-image.png}};
		\node[draw, below=0.5cm of output, circle] (loss){$\mathcal{L}$};
		\node[] (mask) [below=0.5cm of loss]{\includegraphics[scale=0.3]{python/bin/lesion-segmentation-a-mask-train-masked-image.png}};
		\node[] at (0, 1){$\bm{X}$};
...
\begin{figure*}[!t]
	\rotatebox[origin=l]{90}{\hspace{1em}\scriptsize Normalized frequencies}\subfloat[Lung segmentation]{\includegraphics[width=0.33\textwidth]{python/bin/lung-segmentation-hist.png}}
	\subfloat[Lesion segmentation A]{\includegraphics[width=0.33\textwidth]{python/bin/lesion-segmentation-a-hist.png}}
	\subfloat[Lesion segmentation B]{\includegraphics[width=0.33\textwidth]{python/bin/lesion-segmentation-b-hist.png}}
...
\begin{figure}[!t]
	\centering
	\rotatebox[origin=l]{90}{\tiny Lung segmentation}\subfloat{\includegraphics[width=0.12\textwidth]{python/bin/lung-segmentation-Unet-\best-masked-image.png}}
	\subfloat{\includegraphics[width=0.12\textwidth]{python/bin/lung-segmentation-Linknet-\best-masked-image.png}}
	\subfloat{\includegraphics[width=0.12\textwidth]{python/bin/lung-segmentation-FPN-\best-masked-image.png}}
	\subfloat{\includegraphics[width=0.12\textwidth]{python/bin/lung-segmentation-PSPNet-\best-masked-image.png}}
	\\
	\rotatebox[origin=l]{90}{\tiny Lesion segmentation A}\subfloat{\includegraphics[width=0.12\textwidth]{python/bin/lesion-segmentation-a-Unet-\best-masked-image.png}}
	\subfloat{\includegraphics[width=0.12\textwidth]{python/bin/lesion-segmentation-a-Linknet-\best-masked-image.png}}
	\subfloat{\includegraphics[width=0.12\textwidth]{python/bin/lesion-segmentation-a-FPN-\best-masked-image.png}}
	\subfloat{\includegraphics[width=0.12\textwidth]{python/bin/lesion-segmentation-a-PSPNet-\best-masked-image.png}}
	\\
	\rotatebox[origin=l]{90}{\tiny Lesion segmentation B}\subfloat{\includegraphics[width=0.12\textwidth]{python/bin/lesion-segmentation-b-Unet-\best-masked-image.png}}
	\subfloat{\includegraphics[width=0.12\textwidth]{python/bin/lesion-segmentation-b-Linknet-\best-masked-image.png}}
	\subfloat{\includegraphics[width=0.12\textwidth]{python/bin/lesion-segmentation-b-FPN-\best-masked-image.png}}
	\subfloat{\includegraphics[width=0.12\textwidth]{python/bin/lesion-segmentation-b-PSPNet-\best-masked-image.png}}
	\\
	\rotatebox[origin=l]{90}{\tiny Lung segmentation}\subfloat{\includegraphics[width=0.12\textwidth]{python/bin/lung-segmentation-Unet-\best-masked-image.png}}
	\subfloat{\includegraphics[width=0.12\textwidth]{python/bin/lung-segmentation-Linknet-\worst-masked-image.png}}
	\subfloat{\includegraphics[width=0.12\textwidth]{python/bin/lung-segmentation-FPN-\worst-masked-image.png}}
	\subfloat{\includegraphics[width=0.12\textwidth]{python/bin/lung-segmentation-PSPNet-\worst-masked-image.png}}
	\\
	\rotatebox[origin=l]{90}{\tiny Lesion segmentation A}\subfloat{\includegraphics[width=0.12\textwidth]{python/bin/lesion-segmentation-a-Unet-\worst-masked-image.png}}
	\subfloat{\includegraphics[width=0.12\textwidth]{python/bin/lesion-segmentation-a-Linknet-\worst-masked-image.png}}
	\subfloat{\includegraphics[width=0.12\textwidth]{python/bin/lesion-segmentation-a-FPN-\worst-masked-image.png}}
	\subfloat{\includegraphics[width=0.12\textwidth]{python/bin/lesion-segmentation-a-PSPNet-\worst-masked-image.png}}
	\\
	\setcounter{subfigure}{0}
	\rotatebox[origin=l]{90}{\tiny Lesion segmentation B}\subfloat[{\tiny Unet}]{\includegraphics[width=0.12\textwidth]{python/bin/lesion-segmentation-b-Unet-\worst-masked-image.png}}
	\subfloat[{\tiny Linknet}]{\includegraphics[width=0.12\textwidth]{python/bin/lesion-segmentation-b-Linknet-\worst-masked-image.png}}
	\subfloat[{\tiny FPN}]{\includegraphics[width=0.12\textwidth]{python/bin/lesion-segmentation-b-FPN-\worst-masked-image.png}}
	\subfloat[{\tiny PSPNet}]{\includegraphics[width=0.12\textwidth]{python/bin/lesion-segmentation-b-PSPNet-\worst-masked-image.png}}
...
\begin{figure}[!t]
	\centering
	\rotatebox[origin=l]{90}{\hspace{2em}\scriptsize Dice (\%)}\subfloat[Lung segmentation]{\includegraphics[width=0.24\textwidth]{python/bin/lung-segmentation-scatter-dice-vs-num-parameters.png}}
	\subfloat[Lesion segmentation A]{\includegraphics[width=0.24\textwidth]{python/bin/lesion-segmentation-a-scatter-dice-vs-num-parameters.png}}
	\\
	\rotatebox[origin=l]{90}{\hspace{2em}\scriptsize Dice (\%)}\subfloat[Lesion segmentation B]{\includegraphics[width=0.24\textwidth]{python/bin/lesion-segmentation-b-scatter-dice-vs-num-parameters.png}}
	\subfloat[Lesion segmentation B-A]{\includegraphics[width=0.24\textwidth]{python/bin/diff-scatter-dice-vs-num-parameters.png}}
...
\begin{figure}[!t]
	\centering
	\rotatebox[origin=l]{90}{\scriptsize Lung segmentation}\subfloat{\includegraphics[width=0.24\textwidth]{python/bin/lung-segmentation-train-loss.png}}
	\subfloat{\includegraphics[width=0.24\textwidth]{python/bin/lung-segmentation-validation-loss.png}}
	\\
	\rotatebox[origin=l]{90}{\scriptsize Lesion segmentation A}\subfloat{\includegraphics[width=0.24\textwidth]{python/bin/lesion-segmentation-a-train-loss.png}}
	\subfloat{\includegraphics[width=0.24\textwidth]{python/bin/lesion-segmentation-a-validation-loss.png}}
	\\
	\rotatebox[origin=l]{90}{\scriptsize Lesion segmentation B}\subfloat{\includegraphics[width=0.24\textwidth]{python/bin/lesion-segmentation-b-train-loss.png}}
	\subfloat{\includegraphics[width=0.24\textwidth]{python/bin/lesion-segmentation-b-validation-loss.png}}
	\\
	\setcounter{subfigure}{0}
	\rotatebox[origin=l]{90}{\scriptsize Lesion segmentation B-A}\subfloat[Train loss]{\includegraphics[width=0.24\textwidth]{python/bin/lesion-segmentation-b-train-diff-loss.png}}
	\subfloat[Validation loss]{\includegraphics[width=0.24\textwidth]{python/bin/lesion-segmentation-b-validation-diff-loss.png}}
...
\begin{figure}[!t]
	\centering
	\rotatebox[origin=l]{90}{\hspace{1.5em}\scriptsize Dice (\%)}\subfloat[Lung segmentation]{\includegraphics[width=0.24\textwidth]{python/bin/lung-segmentation-boxplot-dice.png}}
	\subfloat[Lesion segmentation A]{\includegraphics[width=0.24\textwidth]{python/bin/lesion-segmentation-a-boxplot-dice.png}}
	\\
	\rotatebox[origin=l]{90}{\hspace{1.5em}\scriptsize Dice (\%)}\subfloat[Lesion segmentation B]{\includegraphics[width=0.24\textwidth]{python/bin/lesion-segmentation-b-boxplot-dice.png}}
	\subfloat[Initialization]{\includegraphics[width=0.24\textwidth]{python/bin/initialization-boxplot-dice.png}}
...
\begin{figure*}[!t]
	\rotatebox[origin=l]{90}{\hspace{1em}\scriptsize Lung segmentation}\subfloat{\includegraphics[width=0.20\textwidth]{python/bin/lung-segmentation-mask--volume.png}} % chktex 8
	\subfloat{\includegraphics[width=0.20\textwidth]{python/bin/lung-segmentation-Unet-None-volume.png}}
	\subfloat{\includegraphics[width=0.20\textwidth]{python/bin/lung-segmentation-Linknet-None-volume.png}}
	\subfloat{\includegraphics[width=0.20\textwidth]{python/bin/lung-segmentation-FPN-None-volume.png}}
	\subfloat{\includegraphics[width=0.20\textwidth]{python/bin/lung-segmentation-PSPNet-None-volume.png}}
	\\
	\rotatebox[origin=l]{90}{\hspace{0.8em}\scriptsize Lesion segmentation A}\subfloat{\includegraphics[width=0.20\textwidth]{python/bin/lesion-segmentation-a-mask--volume.png}} % chktex 8
	\subfloat{\includegraphics[width=0.20\textwidth]{python/bin/lesion-segmentation-a-Unet-None-volume.png}}
	\subfloat{\includegraphics[width=0.20\textwidth]{python/bin/lesion-segmentation-a-Linknet-None-volume.png}}
	\subfloat{\includegraphics[width=0.20\textwidth]{python/bin/lesion-segmentation-a-FPN-None-volume.png}}
	\subfloat{\includegraphics[width=0.20\textwidth]{python/bin/lesion-segmentation-a-PSPNet-None-volume.png}}
	\\
	\setcounter{subfigure}{0}
	\rotatebox[origin=l]{90}{\hspace{0.8em}\scriptsize Lesion segmentation B}\subfloat[Mask]{\includegraphics[width=0.20\textwidth]{python/bin/lesion-segmentation-b-mask--volume.png}} % chktex 8
	\subfloat[Unet]{\includegraphics[width=0.20\textwidth]{python/bin/lesion-segmentation-b-Unet-None-volume.png}}
	\subfloat[Linknet]{\includegraphics[width=0.20\textwidth]{python/bin/lesion-segmentation-b-Linknet-None-volume.png}}
	\subfloat[FPN]{\includegraphics[width=0.20\textwidth]{python/bin/lesion-segmentation-b-FPN-None-volume.png}}
	\subfloat[PSPNet]{\includegraphics[width=0.20\textwidth]{python/bin/lesion-segmentation-b-PSPNet-None-volume.png}}
...
\begin{figure}[!t]
	\centering
	\rotatebox[origin=l]{90}{\scriptsize Random initialization}\subfloat{\includegraphics[width=0.24\textwidth]{python/bin/lung-segmentation-Unet-None-before-weights.png}}
	\subfloat{\includegraphics[width=0.24\textwidth]{python/bin/lung-segmentation-Unet-None-after-weights.png}}
	\\
	\setcounter{subfigure}{0}
	\rotatebox[origin=l]{90}{\scriptsize ImageNet initialization}\subfloat[Before training]{\includegraphics[width=0.24\textwidth]{python/bin/lung-segmentation-Unet-imagenet-before-weights.png}}
	\subfloat[After training]{\includegraphics[width=0.24\textwidth]{python/bin/lung-segmentation-Unet-imagenet-after-weights.png}}
