...
def segmentation_model(pretrained=True, experiment_name='lung-segmentation', architecture='Unet', encoder='resnet18', encoder_weights='imagenet'):
    ...
    experiment_name ('lung-segmentation', 'lesion-segmentation-a', 'lesion-segmentation-b'): Experiment name
    ...
    if pretrained:
        checkpoint = f'https://github.com/pbizopoulos/comprehensive-comparison-of-deep-learning-models-for-lung-and-covid-19-lesion-segmentation-in-ct/releases/download/v1/{experiment_name}-{architecture.__name__}-{encoder}-{endocer_weights}.pt'
